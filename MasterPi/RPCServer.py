...
import Functions.Grabbing as Grabbing
...
def Avoidance(*target_color):
    print('Avoidance', target_color)
    return runbymainth(Avoidan.setTargetdetParam, target_color)

@dispatcher.add_method
def GrabbingObject(*target_color):
    print('Grabbing', target_color)
    return runbymainth(Grabbing.init, target_color)
