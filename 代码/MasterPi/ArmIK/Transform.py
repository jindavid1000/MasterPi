...
# Build the absolute path to the map_param.npz file
# This assumes Transform.py is in ArmIK/ and map_param.npz is in CameraCalibration/
# which are sibling directories.
current_dir = os.path.dirname(os.path.abspath(__file__))
map_param_path = os.path.join(current_dir, '../CameraCalibration/map_param.npz')

#机械臂原点即云台中心，距离摄像头画面中心的距离， 单位cm
image_center_distance = 20

#加载参数
param_data = np.load(map_param_path)
